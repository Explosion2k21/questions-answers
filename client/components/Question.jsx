...
class Question extends React.Component {
  ...
  onSubmit(question_id) {
    ...
    axios
      .put(`http://164.90.161.236:3001/questions/update/${question_id}`)
      .then((res) => {
        console.log("res", res);
  ...
  render() {
    ...
    return (
      <div>
            ...
            <div>
              <span className="span">
                ...
                <a
                  ...
                  className="help"
                  onClick={() => {
                    this.onSubmit(this.props.questions.question_id);
                  }}
                >
                  Yes({this.props.questions.question_helpfulness})
                </a>
              </span>
            </div>
          ) : (
        ...
        <div>
          {!this.state.load && answers.length < 3 ? null : (
            <a
