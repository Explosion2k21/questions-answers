...
class AnswersList extends React.Component {
  ...
  onSubmit(id) {
    console.log(id);
    axios
      .put(`http://164.90.161.236:3001/questions/updateAnswer/${id}`)
      .then((res) => {
        console.log("res", res);
      ...
      <div className="answers-style">
        ...
        <div className="answers-details">
          <p style={{ marginLeft: "20px" }} className="paragraph">
            by {this.props.answers.answerer_name},
          </p>
          <p style={{ marginLeft: "10px" }} className="paragraph">
            {moment(this.props.answers.date).format("ll")} |{" "}
          </p>
          {this.state.bolean ? (
            <div>
              <span style={{ marginLeft: "10px" }} className="span">
                ...
                <a
                  ...
                  className="help"
                  onClick={() => {
                    this.onSubmit(this.props.answers.id);
                  }}
                >
                  Yes({this.props.answers.helpfulness}) |{" "}
                </a>
              </span>
            </div>
          ) : (
          ...
          <a style={{ marginLeft: "10px" }} href="#" className="help">
            Report
          </a>
        </div>
      </div>
